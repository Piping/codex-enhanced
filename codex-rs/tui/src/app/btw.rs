...
use codex_btw::full_insert_text;
use codex_btw::merge_developer_instructions;
use codex_btw::preview_text;
use codex_btw::summarize_message;
...
impl App {
    ...
    pub(crate) fn insert_btw_full(&mut self) {
        ...
        let text = full_insert_text(message);
