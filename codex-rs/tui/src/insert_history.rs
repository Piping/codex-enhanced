...
impl From<HistoryLineWrapPolicy> for ScrollbackWrapMode {
    fn from(wrap_policy: HistoryLineWrapPolicy) -> Self {
        match wrap_policy {
            HistoryLineWrapPolicy::PreWrap => Self::Adaptive,
            HistoryLineWrapPolicy::Terminal => Self::PreserveLines,
        }
    }
}
...
where
    B: Backend + Write,
{
    insert_history_lines_with_mode_and_wrap(terminal, lines, mode, wrap_policy.into())
}
